...
public class BubbleDispatcherTest {
    ...
    public void setUp() throws IOException {
        String meta = "H\tVN:Z:1.0\n" 
                ...
                + "L\t1\t+\t2\t+\t0M\n" 
                + "S\t2\tsomedData\t*\tORI:Z:G-1.fasta;G-2.fasta;G-3.fasta;G-4.fasta;G-5.fasta"
                + "\tCRD:Z:G-1.fasta\tCRDCTG:Z:MT_H37RV_BRD_V5\tCTG:Z:NZ_KK327777.1\tSTART:Z:0\n"
                + "L\t2\t+\t3\t+\t0M\n" 
                + "L\t2\t+\t4\t+\t0M\n" 
                ...
                + "S\t4\tsomedData\t*\tORI:Z:G-4.fasta;G-5.fasta\tCRD:G-4.fasta"
                      + "\tCRDCTG:Z:MT_H37RV_BRD_V5\tCTG:Z:NZ_KK327777.1\tSTART:Z:0\n"
                + "L\t4\t+\t5\t+\t0M\n" 
                + "S\t5\tsomedData\t*\tORI:Z:G-1.fasta;G-2.fasta;G-3.fasta;G-4.fasta;G-5.fasta"
                ...
                + "S\t15\tsomedData\t*\tORI:Z:G-1.fasta;G-2.fasta;G-3.fasta\tCRD:Z:G-1.fasta"
                      + "\tCRDCTG:Z:MT_H37RV_BRD_V5\tCTG:Z:NZ_KK327777.1\tSTART:Z:0\n"
                + "L\t15\t+\t16\t+\t0M\n" 
                + "S\t16\tsomedData\t*\tORI:Z:G-1.fasta;G-2.fasta;G-3.fasta;G-4.fasta;G-5.fasta"
                      + "\tCRD:Z:G-1.fasta\tCRDCTG:Z:MT_H37RV_BRD_V5\tCTG:Z:NZ_KK327777.1"
                      + "\tSTART:Z:0";
