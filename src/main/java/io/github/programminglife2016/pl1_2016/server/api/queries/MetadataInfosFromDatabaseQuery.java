 ...
 */
public class MetadataInfosFromDatabaseQuery implements ApiQuery {
     ...
     */
    public MetadataInfosFromDatabaseQuery(FetchDatabase fdb) {
        this.fdb = fdb;
    }
    /**
    ...
    public ApiAction getApiAction() {
        return args -> fdb.getMetadatas().toString();
    }
}
