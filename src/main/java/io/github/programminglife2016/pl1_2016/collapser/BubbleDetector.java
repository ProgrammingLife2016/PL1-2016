...
public class BubbleDetector {
    ...
    public void findMultiLevelBubbles() {
        ...
        levelBubbles.put(1, findLevelBubbles(this.collection.get(1), null));
        this.reachedLevel++;
        for (int i = 0; i < 3; i++) {
